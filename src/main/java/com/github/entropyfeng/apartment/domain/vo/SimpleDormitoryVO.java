...
public class SimpleDormitoryVO {

    public SimpleDormitoryVO(){

    }

    public SimpleDormitoryVO(Dormitory dormitory,BuildingAndGroup buildingAndGroup) {
        ...
        InGender inGender = dormitory.getInGender();
        if (inGender == null) {
            this.inGender = InGender.UNKNOWN.name();
        } else {
            this.inGender = inGender.name();
        }
        DormitoryDirection direction = dormitory.getDormitoryDirection();
        if (direction == null) {
            this.dormitoryDirection = DormitoryDirection.UNKNOWN.name();
        } else {
            this.dormitoryDirection = direction.name();
        }
