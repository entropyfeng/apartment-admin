...
public interface OrderDormitoryService {
    ...
    List<DormitoryVO> filterAvailableDormitory(List<DormitoryBlock> blocks);

    Boolean hasInDormitory(@NotNull String residentId);

    Boolean hasDormitory(@NotNull String residentId);
    ...
    void checkInDormitory(@NotNull String scheduleName,@NotNull String residentId, @NotNull Integer dormitoryId, @NotNull Integer bedId) throws AlreadyCheckInException;
